        ...
        <div className="listings">
          <h1>Acerca de</h1>
            <div className="max-w-3xl mx-auto p-4 text-gray-800">
                ...
                <ul className="token__details">
                    <li><strong>Financiar la billetera:</strong> En tu billetera cripto, por ejemplo Metamask, asegurate que estes conectado a la red de Ethereum principal o la red donde se encuentren tus fondos. Elige la 3ra opcion bridges o puestes y elige la cantidad de ETH que enviaras, en la opcion de elegir red de destino selecciona Base y da click en enviar. Asegurate de cambiar Metamask a la red de Base antes de comenzar a utilizar meme dorado.  .</li>
